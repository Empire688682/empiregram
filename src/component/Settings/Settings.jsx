          ...
          {settingTag === "notifications" && (
            <div className={style.container}>
              ...
              <p style={{ color: "#1c1e21" }}>
                Empiregram may still send you important notifications about your
                  ...
                  {hiddenTag === "comments" && (
                    <div className={style.hidden_content}>
                      ...
                      <div className={style.hidden_btn}>
                        ...
                        <div className={style.btn_btn}></div>
                      </div>
                      <div className={style.hidden_btn}>
                        <div className={style.btn_text}>
              ...
              <div className={style.cart}>
                <div className={style.secondary_cart}>
                  <div className={style.cart_left}>
                    ...
                    <p>
                      Your default audience is set to Public. This will be your
                      audience for future posts, but you can always change it
                      for a specific post.
                    </p>
                  </div>
                ...
                <div className={style.secondary_cart}>
                  <div className={style.cart_left}>
                    ...
                    <p>
                      Visual search finds other content on Facebook related to
                      your post, to help people discover more of what they are
                      interested in. This is your default, but you can always
                      change it for specific posts.{" "}
                    </p>
                  </div>
                  <div className={style.cart_right}>
