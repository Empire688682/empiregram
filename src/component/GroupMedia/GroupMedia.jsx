    ...
    <div className={style.groupMediaContainer}>
      <div className={style.groupMedia}>
        ...
        <div className={style.displayMenu}>
          <li
            className={displayMenu === "photos" ? `${style.active}` : ""}
            onClick={() => setDisplayMenu("photos")}
          >
            Photos
          </li>
          <li
            className={displayMenu === "videos" ? `${style.active}` : ""}
            onClick={() => setDisplayMenu("videos")}
          >
            Videos
          </li>
          <li
            className={displayMenu === "albums" ? `${style.active}` : ""}
            onClick={() => setDisplayMenu("albums")}
          >
            Albums
          </li>
        </div>
