    ...
    <div className={style.your_groups}>
      {showGroups !== "allYourGroup" && (
        <div className={style.pending_group_con}>
          ...
          <p>
            ...
            magni sunt similique unde quibusdam cupiditate modi autem ut
            architecto! Sapiente, repudiandae facilis dicta neque laborum ipsam
            quisquam vitae atque natus.
          </p>
              ...
              <div className={style.pending_group_cart} key={id}>
                <div className={style.pending_group_header}>
                  <div className={style.pending_group_img_con}>
                    <Image
                      className={style.pending_group_img}
                      src="/img1.jpg"
                      alt="IMG"
                      fill
                    />
      ...
      <div className={style.group_you_are_con}>
        ...
        <p>
          ...
          sunt similique unde quibusdam cupiditate modi autem ut architecto!
          Sapiente, repudiandae facilis dicta neque laborum ipsam quisquam vitae
          atque natus.
        </p>
        <div className={style.group_you_are_cart_con}>
          {Array.from({ length: 10 }).map((group, id) => (
            <div
              className={style.group_you_are_cart}
              key={id}
            ...
            >
              <div className={style.group_you_are_header}>
                <div className={style.group_you_are_img_con}>
                  <Image
                    className={style.group_you_are_img}
                    src="/img1.jpg"
                    alt="IMG"
                    fill
                  />
