          ...
          <div className={style.inviteShareCon}>
            ...
            <div className={style.inviteShareBtns}>
              <li className={style.btn}>
                <FaPlus className={style.icon} /> <span>Invite</span>{" "}
              </li>
              <li className={style.btn}>
                <IoIosShareAlt className={style.icon} /> <span>Share</span>
              </li>
              <div className={style.parentBtn}>
                <li
                  className={style.btn}
                  onClick={() => setShowChildrenBtn(!showChildrenBtn)}
                >
                  <MdGroups2 className={style.icon} /> <span>Joined</span>
                  {showChildrenBtn ? (
                ...
                {showChildrenBtn && (
                  <div className={style.childrenBtn}>
                    <li className={style.btn}>
                      ...
                      <span>Manage notificatiuon</span>
                    </li>
                    <li className={style.btn}>
                      <RiUserUnfollowLine className={style.icon} />{" "}
            ...
            <ul className={style.inviteShareMenus}>
              <li
                className={
                  inviteShareMenus === "discussion"
                    ? `${style.menu} ${style.active}`
                    : style.menu
                }
                onClick={() => setInviteShareMenus("discussion")}
              >
                Discussion{" "}
              </li>
              <li
                className={
                  inviteShareMenus === "event"
                    ? `${style.menu} ${style.active}`
                    : style.menu
                }
                onClick={() => setInviteShareMenus("event")}
              >
                Events
              </li>
              <li
                className={
                  inviteShareMenus === "media"
                    ? `${style.menu} ${style.active}`
                    : style.menu
                }
                onClick={() => setInviteShareMenus("media")}
              >
                Media
              </li>
            </ul>
